...
namespace Libreria_VR_Peliculas.Implementaciones
{
    public class Rentas_Peliculas_Negocio : IRentas_Peliculas_Negocio
    {
        ...
        public List<Rentas_Peliculas> Consultar()
        {
            ...
            var audit = new Auditorias { Tabla = "Rentas_Peliculas", Accion = "Consultar", Fecha = DateTime.Now, DatosAnteriores = null, DatosNuevos = "Se consultaron registros de Rentas_Peliculas" };
        ...
        public Rentas_Peliculas Guardar(Rentas_Peliculas entidad)
        {
            ...
            var audit = new Auditorias { Tabla = "Rentas_Peliculas", Accion = "Guardar", Fecha = DateTime.Now, DatosAnteriores = null, DatosNuevos = "Se guardó un registro en Rentas_Peliculas" };
            iConexion.Auditorias!.Add(audit);
            iConexion.SaveChanges();
            return entidad;
        }
