...
{
    public class MembresiasHTMLModel : PageModel
    {
        ...
        public void OnPostBtGuardar()
        {
            try
            {
                ...
                if (Actual.Id == 0)
                    Actual = IMembresias!.Guardar(Actual!);
                else
                    Actual = IMembresias!.Modificar(Actual!);
